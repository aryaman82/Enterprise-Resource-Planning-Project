    ...
    <div className="w-screen min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Transactions Page</h2>
          <p className="text-gray-600">This page is under construction. Transaction management features will be added soon.</p>
        </div>
      </div>
    </div>
  );
