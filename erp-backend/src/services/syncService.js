import { fetchPunchData, formatApiDate } from '../api/fetcher.js';
import { insertPunchData } from './dataInserter.js';
...
export { syncPunchData, syncPunchDataRange };

export default { syncPunchData, syncPunchDataRange };